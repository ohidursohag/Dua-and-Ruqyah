    ...
    <>
      <div className=" grid xl:grid-cols-[105px,1fr] gap-6">
        ...
        <div className="grid grid-rows-[68px,1fr] md:grid-rows-[91px,1fr] xl:grid-rows-[52px,1fr] gap-6">
          <TopBar />
          <div className="grid grid-col-1 px-3 2lg:grid-cols-[320px,1fr] xl:grid-cols-[320px,1fr]  2xl:grid-cols-[300px,1fr,270px] 2xl:px-0 3xl:grid-cols-[350px,1fr,300px] gap-6">
            <DuaCategories />
            {children}
