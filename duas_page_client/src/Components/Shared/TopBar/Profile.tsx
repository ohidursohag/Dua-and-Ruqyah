  ...
  return (
    <div className="flex md:flex-row-reverse justify-end xl:flex-row items-center gap-5 relative">
      ...
      ref={refWraper}
        ...
        <FaCaretDown size={20} className={`text-icon duration-300 ${openDropdown?'rotate-180':''}`} />
      </div>
      ...
      <div 
        ...
        {/* support us */}
        <Link href={'#'} className="flex cursor-pointer items-center gap-5 hover:bg-secondary-bg py-2 px-3 rounded-2xl duration-300">
          <span>
            <svg
